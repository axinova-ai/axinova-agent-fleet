...
argument-hint: "[task-id] [model: codex|ollama]"
---
...
- **A)** Add a `MODEL: $ARGUMENTS[1]` override (e.g., `MODEL: codex` to force Codex CLI, `MODEL: ollama` for local model)
