...
- Firewall on Aliyun SG server (only port 39999/udp exposed; internal AWG port behind iptables DNAT)
...
- [ ] Firewall on Aliyun SG server (port 39999 only, DNAT to internal AWG port)
